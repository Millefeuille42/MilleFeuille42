...
/*   Updated: 2020/01/30 15:12:19 by mlabouri         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(void)
{
		//ft_printf("%Bonsoir %s je suis test [%c] %% %0*s files", "mlabouri", 'h', "niktoi");
		printf("\nBonsoir %s je suis test [%c] %% %0*1*s files", "mlabouri", 'h', 6, 7, "1234");
