...
/*   Updated: 2020/01/30 11:45:12 by mlabouri         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(void)
{
		ft_printf("%Bonsoir %s je suis test [%c] yes %% %-10s files", "mlabouri", 'h', "niktoi");
		printf("\nBonsoir %s je suis test [%c] yes %% %-10s files", "mlabouri", 'h', "niktoi");
