...
ClapTrap::ClapTrap(const std::string& name, int hit, int nrg, int damages) :
		_name(name), _hitPoints(hit), _energyPoints(nrg), _damages(damages) {
	std::cout << "Inheritance Parameter constructor called" << std::endl;
}
